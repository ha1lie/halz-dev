  ...
  render() {
    return(
      <Box direction='column'>
        <HomeCard imageSide='left' color='rubyPink' textColor='white' backgroundString="url('/foliage.jpg')" />
        ...
        <HomeCard imageSide='right' color='violentBlue' textColor='white' backgroundString="url('/starbucks.jpg')" topTitle='Leading' bottomTitle='Bravely' bodyText='Three years of experience teaching martial arts and aiding individuals learn to code, with guidance and a leading project manager.' />
      </Box>
    );
  }
}
